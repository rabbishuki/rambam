...
export function ChapterDivider({ chapterNumber }: ChapterDividerProps) {
  return (
    <div className="text-center my-6 relative">
      ...
      {/* Chapter badge */}
      <span className="relative z-[1] inline-block bg-[var(--color-surface)] px-4 py-2 text-base font-semibold text-[var(--color-primary)] border border-[var(--color-surface-border)] rounded-full">
